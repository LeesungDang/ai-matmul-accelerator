...
matmul4mmiorandom: vectors4
	mkdir -p build waveforms
	iverilog -g2012 -o build/matmul_4x4_mmio_random_tb tb/tb_matmul_4x4_mmio_random.sv rtl/matmul_4x4_mmio.sv
	vvp build/matmul_4x4_mmio_random_tb
